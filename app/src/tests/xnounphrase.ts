...
const blueprints: { [name in ConstituentType]: Member[] } = {
    ...
    'nounphrase': [
        { type: ['uniquant', 'existquant'], number: '1|0', name: 'subject' },
        { type: ['indefart', 'defart'], number: '1|0', name: 'article' },
        { type: ['adj'], number: '*', name: 'adjectives' }, //TODO: implement parse more than one!!!!
        { type: ['noun'], number: '1|0', name: 'noun' },
        { type: ['copulasubclause', /*'iverbsubclause', 'mverbsubclause1', 'mverbsubclause2'*/], number: '*', name: 'subclause' },
        { type: ['complement'], number: '*', name: 'complements' },
    ],
    'complement': [
    ...
    'complexsentence1': [
        ...
        { type: ['copulasentence', 'mverbsentence'], number: 1 },
        { type: ['then'], number: '1|0' },
        { type: ['copulasentence'], number: 1 }
    ],
    'complexsentence2': [
        { type: ['copulasentence', 'mverbsentence'], number: 1 },
        { type: ['subconj'], number: 1 },
