...
class And {
    ...
    query(query, opts) {
        ...
        const maps = (0, newUnification_1.solveMaps)(candidates);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.newUnification = exports.solveMaps = void 0;
...
function solveMaps(data) {
    ...
    // console.log({ allVarz })
    const allValsOfMem = allVarz.map(x => ({ [x]: allValsOf(oneEntryMaps, x) })).reduce((a, b) => (Object.assign(Object.assign({}, a), b)), {});
