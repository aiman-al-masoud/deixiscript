...
class BaseThing {
    constructor(args) {
        ...
        this.getLexemes = () => {
            const lexemes = this.getAllKeys().flatMap(x => {
                var _a;
                try {
                    const o = (_a = this.get(x)) === null || _a === void 0 ? void 0 : _a.unwrap();
                    const lex = (0, Lexeme_1.makeLexeme)({
                        type: (0, typeOf_1.typeOf)(o),
                        root: x
                    });
                    return [lex];
                }
    ...
    query(clause, parentMap = {}) {
        ...
        if (oc.length === 1) { //BASECASE: check yourself
            ...
            if (this.name === ((_a = clause.simple.predicate) === null || _a === void 0 ? void 0 : _a.root)) {
