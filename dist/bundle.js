...
class BaseWrapper {
    ...
    ownerInfo(q) {
        ...
        // console.log('nested=', nested, 'queryRes=', this.query(q))
        ...
        // console.log('q=', q.toString(), 'maps=', maps, 'newClause=', newClause.toString())
