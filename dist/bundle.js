...
class BaseWrapper {
    ...
    set(predicate, opts) {
        ...
        const path = props.length > 0 ?
            [...props.slice(0, -1), ...(_d = (_c = this.aliases[last]) === null || _c === void 0 ? void 0 : _c.path) !== null && _d !== void 0 ? _d : [last]] :
            (_f = this.aliases[(_e = predicate === null || predicate === void 0 ? void 0 : predicate.concepts) === null || _e === void 0 ? void 0 : _e[0]]) === null || _f === void 0 ? void 0 : _f.path;
    ...
    setMultiProp(path, value, opts) {
        ...
        else if (!(opts === null || opts === void 0 ? void 0 : opts.negated)) {
    ...
    get(clause) {
        ...
        if (x) {
            const path = (_c = (_b = (_a = this.aliases) === null || _a === void 0 ? void 0 : _a[x.root]) === null || _b === void 0 ? void 0 : _b.path) !== null && _c !== void 0 ? _c : [x.root];
            let parent = this;
            path.forEach(p => {
