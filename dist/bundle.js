...
function staticPrecedence(a, b) {
    const ascendingPrecedence = exports.constituentTypes.slice(0, 3);
...
class KoolParser {
    ...
    parse() {
        const sortedConstituentTypes = this.config.constituentTypes.slice().sort((a, b) => (0, syntaxes_1.maxPrecedence)(b, a));
        console.log(sortedConstituentTypes);
