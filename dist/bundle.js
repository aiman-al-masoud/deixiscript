...
class BaseWrapper {
    ...
    set(predicate, opts) {
        ...
        if (props.length > 0) {
            ...
            const propx = [...props.slice(0, -1), ...(_d = (_c = this.aliases[last]) === null || _c === void 0 ? void 0 : _c.path) !== null && _d !== void 0 ? _d : [last]];
