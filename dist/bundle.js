    ...
    constructor(sourceCode, config, lexer = (0, Lexer_1.getLexer)(sourceCode, config)) {
        ...
        this.parseComposite = (name, role) => {
            ...
            for (const m of this.config.getSyntax(name)) {
                ...
                const astType = !ast.list ? ast.type : (_b = (_a = ast === null || ast === void 0 ? void 0 : ast.list) === null || _a === void 0 ? void 0 : _a.at(0)) === null || _b === void 0 ? void 0 : _b.type;
                if (astType) {
