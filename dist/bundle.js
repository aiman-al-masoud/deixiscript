...
function verbSentenceToClause(ast, args) {
    ...
    const verb = (_f = (_e = (_d = ast.links) === null || _d === void 0 ? void 0 : _d.mverb) === null || _e === void 0 ? void 0 : _e.lexeme) !== null && _f !== void 0 ? _f : (_h = (_g = ast.links) === null || _g === void 0 ? void 0 : _g.iverb) === null || _h === void 0 ? void 0 : _h.lexeme;
    if (!verb) {
        throw new Error('missing verb in verb sentence!');
    }
    const rheme = object === Clause_1.emptyClause ? (0, Clause_1.clauseOf)(verb, subjId) : (0, Clause_1.clauseOf)(verb, subjId, objId);
    return subject
        .and(object)
