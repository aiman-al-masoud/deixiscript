...
class And {
    ...
    query(query, opts) {
        ...
        const result = [];
        const it = (_a = opts === null || opts === void 0 ? void 0 : opts.it) !== null && _a !== void 0 ? _a : (0, Id_1.sortIds)(universe.entities).at(-1);
