...
function nounPhraseToClause(ast, args) {
    ...
    const genitiveComplement = Object.values((_h = ast === null || ast === void 0 ? void 0 : ast.links) !== null && _h !== void 0 ? _h : {}).filter(x => { var _a; return (_a = x.links) === null || _a === void 0 ? void 0 : _a.owner; }).at(0); // .flatMap(x => x.list!).filter(x => x.links?.preposition).map(x => complementToClause(x, { subject: subjectId, autovivification: false, sideEffects: false })).reduce((a, b) => a.and(b), emptyClause)
