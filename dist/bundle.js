...
class BaseWrapper {
    ...
    dynamic() {
        return (0, allKeys_1.allKeys)(this.object).map(x => {
            return (0, Lexeme_1.makeLexeme)({ type: typeOf(this.object[x]), root: x });
        });
    }
    unwrap() {
        return this.object;
