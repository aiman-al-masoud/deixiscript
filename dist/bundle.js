...
class BaseThing {
    ...
    query(clause, parentMap = {}) {
        ...
        const aboutTopLevel = clause
            ...
            .reduce((a, b) => a.and(b), Clause_1.emptyClause);
        const notOk = aboutTopLevel.flatList().filter(x => { var _a, _b; return !(this.isAlready({ predicate: (_a = x.predicate) === null || _a === void 0 ? void 0 : _a.referent, args: [] }) || this.name === ((_b = x.predicate) === null || _b === void 0 ? void 0 : _b.root)); });
        if (notOk.length) {
            return [];
        }
        const peeled = clause
...
function isPlural(ast) {
    ...
    // console.log(Object.values(ast?.links ?? {}))
