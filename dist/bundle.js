...
const stem_1 = __webpack_require__(/*! ../lexer/functions/stem */ "./app/src/lexer/functions/stem.ts");
class BasicConfig {
    ...
    setLexeme(lexeme) {
        ...
        if (!lexeme.isPlural) {
            const tok = (0, stem_1.pluralize)(lexeme.root);
            if (this._lexemes.some(x => x.token === tok)) {
                return;
            }
            const plur = (0, Lexeme_1.makeLexeme)({ _root: lexeme, token: tok, cardinality: '*' } /* TODO! 2+ */);
            this.setLexeme(plur);
        }
    }
}
...
function dynamicLexeme(word, context, words) {
    var _a;
    const stemmedWord = (0, stem_1.stem)(word);
    const types = words
    ...
    const type = (_a = types[0]) !== null && _a !== void 0 ? _a : (isMacroContext ?
        'grammar'
        : 'noun');
    return (0, Lexeme_1.makeLexeme)({ root: stemmedWord, type: type });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.pluralize = exports.stem = void 0;
function stem(word) {
