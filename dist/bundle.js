...
class EditAction {
    ...
    run(context) {
        ...
        const wrapper = (_b = (0, getKool_1.getKool)(context, searchSpace, localId)) !== null && _b !== void 0 ? _b : context.enviro.set((0, getIncrementalId_1.getIncrementalId)());
...
class RelationAction {
    ...
    run(context) {
        ...
        const args = ((_a = this.clause.args) !== null && _a !== void 0 ? _a : [])
            .map(x => (0, getKool_1.getKool)(context, this.topLevel.theme, x));
...
function getKool(context, clause, localId) {
    ...
    if (ownerIds.length === 0) {
        const globalId = (_b = (_a = context.enviro.query(clause)) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b[localId];
        return context.enviro.get(globalId);
    }
    const owner = getKool(context, clause, ownerIds[0]);
    return owner === null || owner === void 0 ? void 0 : owner.get(clause.about(localId));
}
