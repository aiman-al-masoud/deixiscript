...
class BaseEnviro {
    ...
    set(id, object) {
        if (!object) {
            return this.dictionary[id] = new Placeholder_1.Placeholder();
        }
        else {
