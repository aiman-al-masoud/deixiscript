...
class SimpleAction {
    ...
    run(context) {
        ...
        const args = this.clause
            .args
            .map(x => { var _a; return (_a = (0, getKool_1.getKool)(context, this.topLevel.theme, x)[0]) !== null && _a !== void 0 ? _a : context.set((0, Wrapper_1.wrap)({ id: (0, getIncrementalId_1.getIncrementalId)() })); });
