...
const tagNameFromProto_1 = __webpack_require__(/*! ../../utils/tagNameFromProto */ "./app/src/utils/tagNameFromProto.ts");
class CreateAction {
    constructor(clause, topLevel) {
        this.clause = clause;
        this.topLevel = topLevel;
    ...
    run(context) {
        ...
        const o = newInstance((0, getProto_1.getProto)(predicate), context, id);
        context.enviro.set(id, o).set(predicate);
    }
}
exports["default"] = CreateAction;
function newInstance(proto, context, id) {
    var _a;
    if (proto instanceof HTMLElement) {
        const o = document.createElement((0, tagNameFromProto_1.tagNameFromProto)(proto));
        o.id = id + '';
