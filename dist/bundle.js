...
class CreateLexemeAction {
    ...
    run(context) {
        var _a, _b, _c, _d, _e;
        if (!context.config.lexemeTypes.includes((_a = this.clause.predicate) === null || _a === void 0 ? void 0 : _a.root) && !this.topLevel.rheme.flatList().some(x => (0, isConcept_1.isConcept)(x.predicate))) {
            return;
        }
        ...
        const concepts = type === 'noun' ? [] : type === 'adjective' ? [(_d = this.clause.predicate) === null || _d === void 0 ? void 0 : _d.root].flatMap(x => x !== null && x !== void 0 ? x : []) : undefined;
...
function getAction(clause, topLevel) {
    ...
    if (topLevel.flatList().some(x => { var _a; return ((_a = x.predicate) === null || _a === void 0 ? void 0 : _a.type) === 'grammar'; })
        || topLevel.rheme.flatList().some(x => (0, isConcept_1.isConcept)(x.predicate))) {
...
function isConcept(lexeme) {
    return (lexeme === null || lexeme === void 0 ? void 0 : lexeme.type) === 'noun' && (lexeme === null || lexeme === void 0 ? void 0 : lexeme.concepts) && !lexeme.proto;
}
