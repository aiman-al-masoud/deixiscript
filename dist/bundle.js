...
class BasicBrain {
    ...
    execute(natlang) {
        return (0, Parser_1.getParser)(natlang, this.context).parseAll().map(ast => {
            ...
            const clause = (0, toClause_1.toClause)(ast).simplify;
...
class And {
    constructor(clauses, clause2IsRheme, negated, exactIds, isSideEffecty, hashCode, clause1, clause2) {
        var _a, _b;
        if (clause2IsRheme === void 0) { clause2IsRheme = false; }
        if (negated === void 0) { negated = false; }
        if (exactIds === void 0) { exactIds = false; }
        if (isSideEffecty === void 0) { isSideEffecty = false; }
        if (hashCode === void 0) { hashCode = (0, hashString_1.hashString)(JSON.stringify(arguments)); }
        if (clause1 === void 0) { clause1 = (_a = clauses[0]) !== null && _a !== void 0 ? _a : Clause_1.emptyClause; }
        if (clause2 === void 0) { clause2 = (_b = clauses[1]) !== null && _b !== void 0 ? _b : Clause_1.emptyClause; }
        ...
        this.about = (id) => { var _a, _b; return optionalAnd((_a = this.clause1) === null || _a === void 0 ? void 0 : _a.about(id), (_b = this.clause2) === null || _b === void 0 ? void 0 : _b.about(id)); };
        this.ownedBy = (id) => { var _a, _b; return optionalCat((_a = this.clause1) === null || _a === void 0 ? void 0 : _a.ownedBy(id), (_b = this.clause2) === null || _b === void 0 ? void 0 : _b.ownedBy(id)); };
        this.ownersOf = (id) => { var _a, _b; return optionalCat((_a = this.clause1) === null || _a === void 0 ? void 0 : _a.ownersOf(id), (_b = this.clause2) === null || _b === void 0 ? void 0 : _b.ownersOf(id)); };
        this.describe = (id) => { var _a, _b; return optionalCat((_a = this.clause1) === null || _a === void 0 ? void 0 : _a.describe(id), (_b = this.clause2) === null || _b === void 0 ? void 0 : _b.describe(id)); };
    }
    and(other, opts) {
        var _a;
        if (isEmpty(this)) {
    ...
    get entities() {
        var _a, _b;
        return (0, uniq_1.uniq)(optionalCat((_a = this.clause1) === null || _a === void 0 ? void 0 : _a.entities, (_b = this.clause2) === null || _b === void 0 ? void 0 : _b.entities));
    }
    implies(conclusion) {
        if (isEmpty(this)) {
            return conclusion;
    ...
    toString() {
        var _a, _b;
        const yes = ((_a = this.clause1) === null || _a === void 0 ? void 0 : _a.toString()) + ',' + ((_b = this.clause2) === null || _b === void 0 ? void 0 : _b.toString());
    ...
    get simplify() {
        var _a, _b;
        const c1 = (_a = this.clause1) === null || _a === void 0 ? void 0 : _a.simplify;
        const c2 = (_b = this.clause2) === null || _b === void 0 ? void 0 : _b.simplify;
        if (!isEmpty(c1) && c1 && isEmpty(c2)) {
            return c1 === null || c1 === void 0 ? void 0 : c1.simplify;
        }
        if (!isEmpty(c2) && c2 && isEmpty(c1)) {
            return c2 === null || c2 === void 0 ? void 0 : c2.simplify;
        }
        if (!isEmpty(c1) && !isEmpty(c2)) {
            return new And([c1 === null || c1 === void 0 ? void 0 : c1.simplify, c2 === null || c2 === void 0 ? void 0 : c2.simplify], this.clause2IsRheme, this.negated, this.exactIds, this.isSideEffecty);
        }
        return this;
    }
}
...
const optionalCat = (x, y) => {
    return [...x !== null && x !== void 0 ? x : [], ...y !== null && y !== void 0 ? y : []];
};
const optionalAnd = (x, y) => {
    return (x !== null && x !== void 0 ? x : Clause_1.emptyClause).and(y !== null && y !== void 0 ? y : Clause_1.emptyClause);
};
...
exports.emptyClause = new And_1.default([]);
...
class Imply {
    ...
    get simplify() {
        return new Imply(this.condition.simplify, this.consequence.simplify, this.negated, this.exactIds, this.isSideEffecty);
    }
}
