...
function getAction(clause, topLevel) {
    ...
    if ((_a = clause.predicate) === null || _a === void 0 ? void 0 : _a.isVerb) { // prepositions? 'of'?
    ...
    if (clause instanceof Imply_1.default && ((_b = clause.subjconj) === null || _b === void 0 ? void 0 : _b.root) === 'if') {
        return new IfAction_1.default(clause);
    }
    if (clause instanceof Imply_1.default && ((_c = clause.subjconj) === null || _c === void 0 ? void 0 : _c.root) === 'when') {
        return new WhenAction_1.default(clause);
    }
    if (clause instanceof Imply_1.default) {
        return new MultiAction_1.default(clause);
    }
    if ((_d = clause.predicate) === null || _d === void 0 ? void 0 : _d.proto) {
