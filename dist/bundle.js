...
class BaseWrapper {
    ...
    // --------------------------------------------------------------------
    ownerInfo(q) {
        const maps = this.query(q).map(m => Object.entries(m).map(e => ({ [e[0]]: e[1].id })).reduce((a, b) => (Object.assign(Object.assign({}, a), b)), {}));
    ...
    query(clause, parentMap = {}) {
        ...
        if (oc.length === 1) { //BASECASE: check yourself
            ...
            if (clause.simple.predicate && (this.is(clause.simple.predicate) || this.name === ((_a = clause.simple.predicate) === null || _a === void 0 ? void 0 : _a.root))) {
                return [Object.assign(Object.assign({}, parentMap), { [clause.entities[0]]: this })];
            }
            return []; //TODO
        }
        // check your children!
...
function getKool(context, clause, localId) {
    ...
    console.log(localId);
    return owner.flatMap(x => { var _a; return (_a = x.get(localId)) !== null && _a !== void 0 ? _a : []; });
}
