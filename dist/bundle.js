...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.stdspace = exports.respace = exports.unspace = exports.isMultiWord = exports.isConcept = exports.getProto = exports.getLexemes = void 0;
const Clause_1 = __webpack_require__(/*! ../clauses/Clause */ "./app/src/clauses/Clause.ts");
function getLexemes(word, context, words) {
    ...
    const lexeme = (_a = context
        ...
        .at(0)) !== null && _a !== void 0 ? _a : dynamicLexeme(word, context, words);
...
function conjugate(lexeme) {
    ...
    const word = (_a = lexeme.token) !== null && _a !== void 0 ? _a : lexeme.root;
    if (lexeme.irregular) {
        return [word, ...(_b = lexeme.forms) !== null && _b !== void 0 ? _b : []];
    }
    return [word, `${word}s`];
}
