...
class BaseWrapper {
    ...
    extraInfo(q) {
        ...
        const oc2 = oc.slice(1).map(x => ({ [x]: `${this.id}${x}` })).reduce((a, b) => (Object.assign(Object.assign({}, a), b)), {});
        return nested !== undefined ? filteredq.copy({ map: Object.assign({ [oc[0]]: this.id }, oc2) }) : Clause_1.emptyClause;
    }
    set(predicate, opts) {
        if (predicate.isVerb) {
