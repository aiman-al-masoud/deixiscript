...
Despite the fair criticism, some from illustrous critics such as Dijsktra, OOP is still the dominant approach in the software industry to this day. It has brought programming abstractions a little closer to the human mind, with its insistence on the "object" metaphor, and for this we owe it something.
