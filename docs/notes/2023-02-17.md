...
Potential problem with "macro context" solution in context sensitive lexer. And more generally problem with macros.

Could be helpful:

'x is an adjective' // not macro vs 'x is adjective' // is macro
